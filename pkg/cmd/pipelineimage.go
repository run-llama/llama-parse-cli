...
var pipelinesImagesGetPageFigure = cli.Command{
	Name:    "get-page-figure",
	Usage:   "Get a specific figure from a page of a file.",
	Suggest: true,
	Flags: []cli.Flag{
	...
	Action:          handlePipelinesImagesGetPageFigure,
	HideHelpCommand: true,
}

var pipelinesImagesGetPageScreenshot = cli.Command{
	Name:    "get-page-screenshot",
	Usage:   "Get screenshot of a page from a file.",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:      "id",
	...
	Action:          handlePipelinesImagesGetPageScreenshot,
	HideHelpCommand: true,
}

var pipelinesImagesListPageFigures = cli.Command{
	Name:    "list-page-figures",
	Usage:   "List metadata for all figures from all pages of a file.",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:      "id",
	...
	Action:          handlePipelinesImagesListPageFigures,
	HideHelpCommand: true,
}

var pipelinesImagesListPageScreenshots = cli.Command{
	Name:    "list-page-screenshots",
	Usage:   "List metadata for all screenshots of pages from a file.",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:      "id",
	...
	Action:          handlePipelinesImagesListPageScreenshots,
	HideHelpCommand: true,
}
...
func handlePipelinesImagesGetPageFigure(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(obj, ShowJSONOpts{
		...
		Title:          "pipelines:images get-page-figure",
		Transform:      transform,
	})
}
...
func handlePipelinesImagesGetPageScreenshot(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(obj, ShowJSONOpts{
		...
		Format:         format,
		RawOutput:      cmd.Root().Bool("raw-output"),
		Title:          "pipelines:images get-page-screenshot",
		Transform:      transform,
	})
}
...
func handlePipelinesImagesListPageFigures(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(obj, ShowJSONOpts{
		...
		Format:         format,
		RawOutput:      cmd.Root().Bool("raw-output"),
		Title:          "pipelines:images list-page-figures",
		Transform:      transform,
	})
}
...
func handlePipelinesImagesListPageScreenshots(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(obj, ShowJSONOpts{
		...
		Format:         format,
		RawOutput:      cmd.Root().Bool("raw-output"),
		Title:          "pipelines:images list-page-screenshots",
		Transform:      transform,
	})
}
