...
func TestPipelinesCreate(t *testing.T) {
	...
	t.Run("inner flags", func(t *testing.T) {
		...
		mocktest.TestRunMockTestWithFlags(
			...
			"--llama-parse-parameters.annotate-line-numbers=true",
			"--llama-parse-parameters.annotate-links=true",
			"--llama-parse-parameters.annotate-revisions=true",
			...
			"--llama-parse-parameters.confidence-score-effort", "confidence_score_effort",
